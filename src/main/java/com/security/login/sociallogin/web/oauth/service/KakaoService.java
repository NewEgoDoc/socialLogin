package com.security.login.sociallogin.web.oauth.service;
...
import com.security.login.sociallogin.web.oauth.provider.profile.KakaoProfile;
...
public class KakaoService {
    ...
    public KakaoProfile findProfile(String token) {
        ...
        System.out.println("[findProfile]token = " + token);
        //Http 요청
        ...
        System.out.println("[findProfile]response = " + response);
        ObjectMapper objectMapper = new ObjectMapper();
